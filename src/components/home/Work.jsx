    ...
    const workContent = {
        thoughtworks: {
            ...
            content: {
                ...
                SOLUTION: "Played a central role in the creation of AiWorks’ “brain”, leveraging my neuroscience research experience to design Model Context Protocols (MCPs), multi-agent deep intelligence systems, and Context Engineering frameworks. Developed and integrated cutting-edge AI tooling, including RAG systems with Cognee, Langchain, Langraph, and Arango.AI. Currently leading the implementation of AiWorks across European clients, combining architecture, prototyping, and performance optimization, while driving adoption of AI agents in practical, scalable solutions. Authored thought leadership articles on Context Engineering and Service-as-Software, exploring the future impact of agentic AI in enterprise markets.",
