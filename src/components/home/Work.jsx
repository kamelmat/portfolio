...
const Work = () => {
    ...
    const workContent = {
        thoughtworks: {
            ...
            skills: ["Java", "AI Research", "MCP Architecture", "Agile", "TDD", "Software Design"],
            content: {
                CONTEXT: "Joined Thoughtworks, a global technology consultancy renowned for pioneering software excellence and innovation. Entered the prestigious one-year Graduate Program, combining advanced technical training, consulting skills, and collaborative project experience. Selected for my unique blend of over 25 years of cross-disciplinary expertise in music, neuroscience, strategy, and software development, which Thoughtworks recognized as a valuable asset to their teams.",
                SOLUTION: "Currently staffed on an advanced internal AI research project, designing and developing a 'brain' architecture to enhance the efficiency of context windows via a Model Context Protocol (MCP). Contribute to architectural decisions, prototyping, and performance optimization, integrating research findings into scalable solutions. Apply my prior entrepreneurial, creative, and technical experience to strengthen team ideation, problem-solving, and delivery.",
                OUTCOME: "Helped drive innovation in context window optimization through novel MCP-based approaches. Actively contributed to shaping early-stage AI capabilities with potential to transform internal tooling and client-facing solutions. Recognized for bridging diverse disciplines into high-impact technical output and for elevating team dynamics through mentorship and creative thinking."
            }
        },        
        geeks: {
